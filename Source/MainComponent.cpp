...
public:
    ...
    float mapping_variable = 0.0f, radius = 0.0f;
    ...
    void render() override
    {
        ...
        mapping_variable = MicInputVisualWidget.access_to_sample();
        radius = mapping_variable;
        ...
        glBegin(GL_LINE_LOOP);
            for (int i=0; i < 360; i++)
            {
                ...
                glVertex2f(radius*cos(DEG_IN_RAD), radius*sin(DEG_IN_RAD));
            }
        glEnd();
    }
